...
export default function TopicsPost({ data }) {
  return (
    <>
      ...
      <p id='page-top'>
        <AnchorLink offset='0' to={'/topics/' + data.microcmsTopics.category.slug + '/' + data.microcmsTopics.topicsId + '/#pagetop'} title='Pagetop'>
      ...
      <section id='page-info' className='topics'>
        ...
        <PageTitle title={data.microcmsTopics.category.name} slug={data.microcmsTopics.category.slug} />
      </section>
      ...
      <Layout>
        <section id='main'>
          ...
          <p className='center'>
            <Link to={'/topics/' + data.microcmsTopics.category.slug + '/'} className='bt01'>
              一覧へ戻る
            </Link>
          </p>
        </section>
